...
export default function FooterPage() {
  return (
    <Footer className='text-left'>
      <div className='container mx-auto grid lg:grid-cols-5 md:grid-cols-2 pt-8 footer-top'>
        <div className='list-footer'>
          <h1 className='tittle-footer'>Categories</h1>
          <div>
            <ul>
        ...
        <div className='list-footer'>
          <h1 className='tittle-footer'>About</h1>
          <div>
            <ul>
              <li className='text-footer'>
                <a href=''>Careers</a>
        ...
        <div className='list-footer'>
          <h1 className='tittle-footer'>Support and Education</h1>
          <div>
            <ul>
              <li className='text-footer'>
        ...
        <div className='list-footer'>
          <h1 className='tittle-footer'>Community</h1>
          <div>
            <ul>
              <li className='text-footer'>
        ...
        <div className='list-footer'>
          <h1 className='tittle-footer'>Business Solution</h1>
          <div>
            <ul>
              <li className='text-footer'>
      ...
      <div className='footer-bottom mt-8 container mx-auto'>
        <div className='left flex'>
          ...
          <p className="text-body-2 legal">
            <span className="copyright text-trunc">©Fiverr International Ltd. 2024</span>
          </p>
        </div>
        <div className='right'>
